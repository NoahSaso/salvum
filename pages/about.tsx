    ...
    <>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.card}>
          <p>
            My name is Noah, and I believe open access to information is one of
            the best tools we have to support well-being while fighting stigma
            and prejudice caused by the War on Drugs. Salvum consolidates harm
            reduction resources in one place in an effort to make safety in or
            around altered states of consciousness as easy as possible.
          </p>
        </div>
        ...
        <div className={styles.support}>
          ...
          <ClipboardButton
            Icon={
              <Image src="/img/solana.svg" width={24} height={24} alt="SOL" />
            }
